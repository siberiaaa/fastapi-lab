...
def get_productos(db: Session = Depends(get_db), info=Depends(auth_handler.auth_wrapper)):
...
def get_producto(id : int, db: Session = Depends(get_db), info=Depends(auth_handler.auth_wrapper)): 
...
def get_productos_artesano(cedula_artesano : int, db: Session = Depends(get_db), info=Depends(auth_handler.auth_wrapper)): 
